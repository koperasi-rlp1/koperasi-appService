...
public class TransaksiApprovalDao {
    ...
    public TransaksiApprovalDTO.PengajuanSimpanan pengajuanSimpanan(TransaksiApprovalDTO.PengajuanSimpanan value) throws DataAccessException{
        String baseQuery = "INSERT INTO \"TN_TRANSAKSI_APPROVAL\"(\"JENIS_TRANSAKSI\", \"NOMINAL_TRANSAKSI\", \"ID_NASABAH\", \"BUKTI_TRANSAKSI\", \"DESKRIPSI\")\n" +
                "VALUES(:jenisTransaksi, :nominalTransaksi, :idNasabah, :buktiTransksi, :deskripsi)";
