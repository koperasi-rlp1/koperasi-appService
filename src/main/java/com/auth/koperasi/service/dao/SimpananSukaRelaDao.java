...
//        parameterSource.addValue("sortDir", request.getSortDir());
    ...
    public List<SimpananSukaRelaDTO.DataSimpanan> datatables(DataTableRequest<SimpananSukaRelaDTO.DataSimpanan> request){
...
//        parameterSource.addValue("sortDir", request.getSortDir());
        ...
        return namedParameterJdbcTemplate.query(query.toString(), parameterSource, new BeanPropertyRowMapper<>(SimpananSukaRelaDTO.DataSimpanan.class));
    }
}
